...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex w-full bg-background text-foreground">
      ...
      {/* Mobile top bar */}
      <div className="md:hidden fixed top-0 left-0 right-0 z-40 bg-surface-1 border-b border-border flex items-center px-4 py-3 gap-2">
        <button
          onClick={() => setMenuOpen(true)}
          className="p-1.5 rounded-sm hover:bg-surface-2 -ml-1.5"
        ...
        <button
          ...
          className="ml-auto rounded-sm bg-gradient-amber text-primary-foreground p-1.5"
        ...
        <div className="md:hidden fixed inset-0 z-50 flex">
          ...
          <aside className="relative w-72 max-w-[85vw] bg-surface-1 border-r border-border flex flex-col animate-fade-in">
            <div className="px-5 py-4 border-b border-border flex items-center gap-3">
              ...
              <button
                onClick={() => setMenuOpen(false)}
                className="p-1.5 rounded-sm hover:bg-surface-2"
            ...
            <div className="px-3 mt-2">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 rounded-sm bg-gradient-amber text-primary-foreground px-3 py-2.5 text-sm font-semibold"
              >
                <Plus className="h-4 w-4" /> New session
              </button>
            </div>
